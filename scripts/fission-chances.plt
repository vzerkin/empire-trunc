...
set title "Fission Chances" 0.000000,0.000000  font ""
set timestamp "" bottom norotate 0.000000,0.000000  ""
set rrange [ * : * ] noreverse nowriteback  # (currently [0.00000:10.0000] )
set trange [ * : * ] noreverse nowriteback  # (currently [-5.00000:5.00000] )
set urange [ * : * ] noreverse nowriteback  # (currently [-5.00000:5.00000] )
set vrange [ * : * ] noreverse nowriteback  # (currently [-5.00000:5.00000] )
set xlabel "Energy [MeV]" 0.000000,0.000000  font ""
set x2label "" 0.000000,0.000000  font ""
set xrange [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Cross Sections [mb]" 0.000000,0.000000  font ""
...
plot 'th32-fiss.xsc' u 1:2 w l, 'th32-fiss.xsc' u 1:3 w l, 'th32-fiss.xsc' u 1:4 w l, 'th32-fiss.xsc' u 1:5 w l, 'th32-fiss.xsc' u 1:6 w l, 'th32-fiss.xsc' u 1:7 w l, 'th32-fiss.xsc' u 1:8 w l, 'th32-fiss.xsc' u 1:9 w l, 'th32-fiss.xsc' u 1:10 w l
pause cr
#    EOF
