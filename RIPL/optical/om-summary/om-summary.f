...
c
      ...
      character*1 ians
      common/clas/nsph,nccvib,nccrot,nccsof,ndisp,nhe,nccrigsof
      nsph = 0      
      nccvib = 0
      nccrot = 0
      nccsof = 0
...
c
 ...
 200  n1=i1
      ...
      write(*,*)'Number of CC vibrational      potentials = ',
     &  nccvib
      write(*,*)'Number of CC rigid rotor      potentials = ',
     &  nccrot      
      write(*,*)'Number of CC soft rotor       potentials = ',                          
     &  nccsof      
      write(*,*)'Number of CC rigid-soft rotor potentials = ',                          
     &  nccrigsof      
...
C     Reading rigid-soft rotor parameters    
 ...
 999  ieof=1
      write(6,*)
     *   'End of RIPL-3 (2012) optical potential library reached.'
      return
      end
...
c
      ...
      if(imodel.eq.4) nccrigsof = nccrigsof + 1                  
...
c
     ...
     3 lrefx(ndim8),irelx(ndim8),disrt(ndim8),djsrt(ndim8)
      common/bcdx/authx(80,ndim8),referx(80,ndim8),summryx(320,ndim8)
      dimension proj(6),mod(5)
      data nct/100000/
      data (proj(id),id=1,6)/' n ',' p ',' d ',' t ','3He','4He'/
      data com/','/,da/'-'/,bl/' '/
      data (mod(i),i=1,5)/'spher. ','CC rig.','CC vib.',
     +    'CC soft','CC r/vi'/
c
