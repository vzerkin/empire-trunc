...
def removeMFMT(infile,outfile,MF,MT = '*',MAT = 0,dumpfile = False):
    """
    removeMFMT(infile,outfile,MF,MT = '*',MAT = 0,dumpfile = False)
    ...
    if dumpfile specified, removed section is written to dumpfile
...
def locate_section(infile, MF, MT, MAT=0, outfile=False):
    """
    locate_section(infile, MF, MT, MAT=0, outfile=False):
