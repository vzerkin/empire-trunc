...
C* ENDRES log file
   18 OPEN (UNIT=LLG,FILE=FLLG,STATUS='UNKNOWN')
      ...
      WRITE(LLG,691) ' ===================================    '
      WRITE(LLG,691) BLNK
      WRITE(LLG,691) ' Source ENDF file to be edited        : '
      WRITE(LLG,690) ' '//FLEM
      WRITE(LLG,691) '                          File header : '
      WRITE(LLG,690) ' '//HD66
      WRITE(LLG,691) ' '
      WRITE(LLG,691) ' Source resonance parameter file      : '
      WRITE(LLG,690) ' '//FLRR
      WRITE(LLG,691) '                          File header : '
      WRITE(LLG,690) ' '//CH66
      WRITE(LLG,691) ' '
      WRITE(LLG,691) ' Output ENDF file                     : '
      WRITE(LLG,691) ' '//FLOU
      WRITE(LLG,691) '                          File header : '
      WRITE(LLG,691) ' '//HD66
      WRITE(LLG,691) ' '
...
C* Add to comments as signature of ENDRES
     ...
     *     //BLNK
      CALL WRTEXT(LSC,MAT,MF,MT,NSS,CH66)
      CH66='  Source ENDF '//FLEM//BLNK
      CALL WRTEXT(LSC,MAT,MF,MT,NSS,CH66)
      CH66='  Resonance ENDF '//FLRR//BLNK
      CALL WRTEXT(LSC,MAT,MF,MT,NSS,CH66)
      NX=N1+3
c...
