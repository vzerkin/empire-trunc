...
!
      ...
      REAL(KIND=R4), DIMENSION(1500) :: EGRID,AEBAR,EINT,PKINT
      REAL(KIND=R4), DIMENSION(1500) :: EBAV,YLD
!
...
!
      INTEGER(KIND=I4) :: MBOUND,NCURR
      INTEGER(KIND=I4) :: IPATH1,IP,INTT,IND
      INTEGER(KIND=I4) :: I,II,J,N
      INTEGER(KIND=I4), PARAMETER :: NGRUPS=203
      REAL(KIND=R4), DIMENSION(NGRUPS) :: EGR
      INTEGER(KIND=I4), PARAMETER :: NREACS= 4
      REAL(KIND=R4), DIMENSION(NREACS) :: RESINT,SIGO
      REAL(KIND=R4), DIMENSION(NGRUPS,NREACS) :: SIGP
      REAL(KIND=R4) :: EPIM,EPIP,ECURR,XSEC
...
!
!     E IS ENERGY AT WHICH CROSS SECTION IS TO BE CALCULATED
!     INOW IS THE FIRST GRID LOCATION IN PACKED STORAGE
!     NE IS THE NUMBER OF GRID POINTS
!     ISKIP IS THE REPETITION RATE FOR VALUES OF THE
!      ENERGY GRIN IN THE PACKED ARRAY, RESPAR
!     EG ARE THE ENERGY GRID VALUES RETURNED
!     NUME IS THE NUMBER OF VALUES IN EG
!     IDG IS POINTER TO EG(1) RELATIVE TO INOW
!
      IMPLICIT NONE
!
