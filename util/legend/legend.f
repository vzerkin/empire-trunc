...
C-----PRINT TOTALS AND TERMINATE.
  ...
  250 FORMAT(' Linearized ENDF/B Angular Distributions (LEGEND 2007-1)'/
     1 1X,78('-'))
...
C       3456
      DATA PROGDOC/
     1 ' ***************** Program LEGEND (VERSION 2007-1) ***********',
...
C-----IF LTT IS NOT 0 TO 4 PRINT ERROR MESSAGE AND COPY SECTION.
      ...
      WRITE(OUTP,320) IZA,MATH,MTH,LTT
      GO TO 130
...
C
   ...
   80 WRITE(OUTP,340) IZALST,MATLST,MTLST
      TYPED(3)=TYPED(3)+1
      GO TO 130
C
...
C
   90 IF(IMLEGS.EQ.1.AND.IMTABS.GT.0) GO TO 100
      WRITE(OUTP,350) IZALST,MATLST,MTLST
      TYPED(4)=TYPED(4)+1
      GO TO 130
C
...
C-----COPY SECTION END LINE.
      CALL COPYS
  280 RETURN
  290 FORMAT(1X,78('-')/' WARNING...Allowable Error=',11A1/
     1 1X,78('-'))
  300 FORMAT(1X,78('-')/' WARNING...Cosines NOT in Ascending Order'/
     1 1X,78('-'))
  310 FORMAT(1X,78('-')/' WARNING...Cosines Do NOT Span -1 to +1'/
     1 1X,78('-'))
  320 FORMAT(I7,I5,I4,' LTT=',I6,' Expect 0 to 4...Section Copied.')
  330 FORMAT(I7,I5,I4,' Isotropic...Copied')
  340 FORMAT(I7,I5,I4,' Legendre Coefficients...Copied')
  350 FORMAT(I7,I5,I4,' Legendre Coefficients + Tabulated...Copied')
  360 FORMAT(I7,I5,I4,' WARNING - Log Interpolation for Legendre'/
