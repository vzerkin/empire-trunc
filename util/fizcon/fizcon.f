...
!
      ...
      INTEGER(KIND=I4), DIMENSION(NTESTS) :: MTFLGS,MTTOT,MSKIP
      INTEGER(KIND=I4), DIMENSION(NTESTS), PARAMETER ::                  &      
     &             IWHO = (/4,18,101,103,104,105,106,107/)
!
      INTEGER(KIND=I4)  :: IMT1,IMT2,NWR
!
!     INITIALIZE
!
      IF(N0.LT.0)   THEN
...
!
      INTEGER(KIND=I4) :: N0
!
      INTEGER(KIND=I4) :: ISTO,MATS,MFS,MTS,NSEQS,N00,ISCRU
!
...
!
      INTEGER(KIND=I4) :: N0
!
      INTEGER(KIND=I4) :: IMT501,IMT516,I515
      INTEGER(KIND=I4) :: I
!
!     INITIALIZE FOR TEST
!
