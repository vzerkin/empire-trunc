...
C-----CONVERT FLOATING POINT NUMBERS TO STANDARD OUTPUT FORM.
   10 CALL OUT9(C1H,FIELD2(1,1),  0)
      CALL OUT9(C2H,FIELD2(1,2),  0)
C-----ELIMINATE -0
      IF(IABS(L1H).LE.0) L1H=0
      IF(IABS(L2H).LE.0) L2H=0
      IF(IABS(N1H).LE.0) N1H=0
...
C-----NO OUTPUT IF OUTPUT UNIT IS TURNED OFF
      ...
      RETURN
C-----CONVERT FLOATING POINT NUMBERS TO STANDARD OUTPUT FORM.
   10 CALL OUT9(C1,FIELD2(1,1),  0)
      CALL OUT9(C2,FIELD2(1,2),  0)
C-----ELIMINATE -0
      IF(IABS(L1).LE.0) L1=0
      IF(IABS(L2).LE.0) L2=0
      IF(IABS(N1).LE.0) N1=0
...
C-----SET FLAG IF POSITIVE.
      ...
      K=K+1
      CALL OUT9(X(II),FIELD6(1,K),II3)
      K=K+1
   10 CALL OUT9(Y(II),FIELD6(1,K),0)
C-----OUTPUT ONE LINE.
      IOUT=(I2-I1)+1
      GO TO (20,30,40),IOUT
