...
\author{B.V. Carlson}
\affiliation{Instituto Tecnologicoï¿½ico de Aeronauticatica, Sao Jose dos Campos SP, Brazil}
...
(including Heavy Ions) or a photon. The energy range extends from the begining of the unresolved resonance region for neutron induced reactions and goes up to few hundred
...
ECIS03\index{ECIS} can be invoked in four different ways. As mentioned
...
\medskip
\paragraph{Level densities at saddles}
