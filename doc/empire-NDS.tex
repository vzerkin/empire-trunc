...
%references
%
%\bibitem{TULnew} {H.~Lenske and H.~Wolter. \textit{Nucl. Phys.} }\textbf{A358%
%}, 483{\ (1992); \textit{Nucl. Phys.}\emph{\ }}\textbf{A690}, 267 (2001).

%\bibitem{fetter} {A.L.~.Fetter and J.D.~Walecka, in \textit{Quantum Theory
%of Many Body Systems}, (McGraw-Hill, New York, 1971)}

%\bibitem{wienke:07} {H.~Wienke, M.~Herman, R.~Capote and M.~Sin, \textit
%proceedings of the International Conference on Nuclear Data for Science and Technology
%2007, Nice, 23-27 april, 2007). pp??}

%\bibitem{nextpaper} {H.~Wienke, M.~Herman, R.~Capote and M.~Sin, to be
%published.}
