...
exciton model \cite{gr66}, which is based on the solution of the master
equation \cite{clbl71} in the form proposed by Cline \cite{cl72} and
Ribansky \cite{riobbe73}:
\begin{eqnarray}
...
\cite{akgrre80}, which produces an exact result for any initial condition of
...
corresponding to the absorbing wells ~\cite{Bhandari:79},\cite{Back:74}. A
...
The fission probability is usually defined as the branching ratio of the
