...
\item[OPTMAN] Coupled-Channels code with soft-rotor capability by Soukhovitskii \emph{et al.}~\cite{OPTMAN}
...
\section{Coupled-Channels Code OPTMAN   UPDATE!!!}
