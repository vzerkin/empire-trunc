...
keyword NAME. If the first character of the line (i.e. NAME(1:1)) is \*,\# or \!, 
then this line contains comments and is ignored by the code.
If the first character of the line (i.e. NAME(1:1)) is \@, 
...
VAL takes numerical value  of the  quantity or  option*).  \\
