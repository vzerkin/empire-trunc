...
\section{Prompt Fission Neutrons}
\label{pfns}
...
\subsection{Los Alamos model for prompt fission neutron spectra}
...
\subsection{Kornilov model for prompt fission neutron spectra}
\label{sec:korn}
...
\subsection{Implementation of the PFNS in EMPIRE code}
\label{sec:empimp}
