...
\vspace {10 mm}
{\Huge
\hfill \textsf {\bf{\color{cyan} EMPIRE-3.2 Malta}}} \\
...
\item [{MIXGDR}] E1 mixing coefficient of Weisskopf and Giant Dipole Resonance Model (GRM) 
gamma-ray strength funtion set to VAL (allowed from 0 to 1. default = 1 means
pure GRM).
\item [{MIXGQR}] E2 mixing coefficient of Weisskopf and Giant Quadrupol Resonance Model (GRM) 
gamma-ray strength funtion set to VAL (allowed from 0 to 1. default = 1 means
pure GRM).
\item [{MIXGMR}] M1 mixing coefficient of Weisskopf and Giant Magnetic Resonance Model (GRM) 
gamma-ray strength funtion set to VAL (allowed from 0 to 1. default = 1 means
pure GRM).
