...
\item[OPTMAN] Coupled-Channels code with soft-rotor capability by Soukhovitskii \emph{et al.}~\cite{OPTMAN1,OPTMAN3,OPTMAN3}
...
\section{Coupled-Channels\index{Coupled-Channels} Code ECIS\index{Raynal70,Raynal72}}
