...
the sake of clarity these modes are described below in the reverse
order.
...
The complete sequence is intended for the production of evaluated 
...
choosen in such a way that input \emph{a} covers the lower part, input
...
isomers. EMPEND recognises these and stores them in ENDF File~10.
