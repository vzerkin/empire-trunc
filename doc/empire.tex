...
\item [{MIXGDR}] E1 mixing coefficient of Weiskopf and Giant Resonance Model (GRM) 
gamma-ray strength funtion set to VAL (allowed from 0 to 1. default = 1 means
pure GRM).
\item [{MIXGQR}] E2 mixing coefficient of Weiskopf and Giant Resonance Model (GRM) 
gamma-ray strength funtion set to VAL (allowed from 0 to 1. default = 1 means
pure GRM).
\item [{MIXGMR}] M1 mixing coefficient of Weiskopf and Giant Resonance Model (GRM) 
gamma-ray strength funtion set to VAL (allowed from 0 to 1. default = 1 means
pure GRM).
