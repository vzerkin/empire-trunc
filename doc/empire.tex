...
choice of input options in the EMPIRE calculations
...
the options from the contents and acts accordingly.
% using MT=5 and specifying relative
...
\item Improved description of direct reactions in complex particle-induced
  reactions (e.g. deuteron, triton and $^3$He),
...
E. Betak (DEGAS), M.B. Chadwick (DDHMS), C.H. Dasso
