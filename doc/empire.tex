...
\addchap{Appendix Description of the EMPIRE optional-input keywords\label{InputList}}
...
Each optional record starts with an alphanumeric keyword NAME. If the first 
character of the line (i.e. NAME(1:1)) is \*,\# or \!, then this line contains
comments and is ignored by the code. There might be an arbitrary number of comments
line in the optional input. If the first character of the line (i.e. NAME(1:1))
is \@, then this line contains a title, which will be printed in EMPIRE outputs; 
