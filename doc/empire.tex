...
The current calculation of the S-factor in EMPIRE follows the above formalism (no energy dependence or very nearly a constant) and can output gammas, neutrons or protons in the exit channel (with either an $\alpha$ or proton (only p,$\gamma$ and p,n for this case) in the incident channel).\par
...
*** More nuclear astrophysics formalism forthcoming (reaction rate formalism)
