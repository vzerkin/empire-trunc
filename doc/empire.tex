...
\section{Coupled-Channels Code OPTMAN}
...
for nuclear data evaluation for reactor design and other applications, being 
...
ECIS \cite{Raynal70} code (which is already included in EMPIRE), 
...
{OPTMANmanual2005} and its newest extension \cite{OPTMANmanual2008} give details
...
withint the EMPIRE system allowing the use of state-of-the-art optical model potentials
