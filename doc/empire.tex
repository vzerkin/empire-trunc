...
\end{equation}
 and the E is ain MeV.  Iliadis (constant from 2$\pi$$\eta$  = (0.989534)*(formulation above)) changed to use EMPIRE constants traceable to NIST (CODATA 2010 set - 2$\pi$$\eta$ = (0.9895106848)*(formulation above)) . \par 
