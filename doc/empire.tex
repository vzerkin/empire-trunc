...
It can also be used to simulate physical effects arising from the compound-direct processes interference
(Engelbrecht-Weidenmuller transformation). The interference tends to reduce the compound elastic, increasing
the compound inelastic cross sections. 
