...
but only for the inelastic channel). No information on coupled levels is given.
...
potentials that use either soft-rotor for spherical nuclei, or deformed vibrational-rotational
...
$\omega_2$, and $\Delta_0$
from RIPL-3 were included in \textit{/data/level-densities-par.dat} and used by EMPIRE.
