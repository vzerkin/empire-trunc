...
\subsection{Architecture of the module}
...
\chapter{Fitting Optical Model Parameters}
...
The current calculation of the S-factor in EMPIRE follows the above formalism (no energy dependence) and can output both gammas or neutrons in the exit channel (with either an $\alpha$ or proton in the incident channel).  
...
\section{Coupled-Channels\index{Coupled-Channels} with RIPL Coupled-Channels
...
\subsection{Coupled-Channels\index{Coupled-Channels} (ECIS\index{ECIS})}
...
\subsection{Multi-step Direct\index{MSD}}
...
\subsection{Multi-step Compound\index{MSC} }
...
\subsection{GDR parameters ($\gamma$-ray strength functions)}
...
\subsection{Avoiding unreasonably low uncertainties}
