Ccc   * $Author: herman $
Ccc   * $Date: 2007-11-28 20:38:32 $
Ccc   * $Id: fitbarrier.f,v 1.3 2007-11-28 20:38:32 herman Exp $
...
C
      ...
      REAL*8 uexcit1, phase(2*NFPARAB)
C-------------------------------------------------------------------
      REAL*8 Uexc, Smiu
...
c     IMPLICIT NONE
      ...
      VdefParab = Vheigth(K) + (-1)**K*(SMIU*Vwidth(K)*(EPS-Vpos(K)))**2
      return
      end
