...
contains
    ...
    subroutine test_clebsch_gordan_wikipedia_values
        ...
        call assert_close(   1.d0/dsqrt(2.D0),      CLEBG( 0.5D0, 0.5D0,  1.d0, 0.5D0, -0.5D0,    0d0 ), 1d-6, 1d-6, 'CG special'  ) 
        call assert_close(   1.d0/dsqrt(2.D0),      CLEBG( 0.5D0, 0.5D0,  1.d0,-0.5D0,  0.5D0,    0d0 ), 1d-6, 1d-6, 'CG special'  ) 
        call assert_close(   1.d0/dsqrt(2.D0),      CLEBG( 0.5D0, 0.5D0,  0.d0, 0.5D0, -0.5D0,    0d0 ), 1d-6, 1d-6, 'CG special'  ) 
        call assert_close(  -1.d0/dsqrt(2.D0),      CLEBG( 0.5D0, 0.5D0,  0.d0,-0.5D0,  0.5D0,    0d0 ), 1d-6, 1d-6, 'CG special'  ) 
