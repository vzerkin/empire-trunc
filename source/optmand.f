...
C     IF(MEHAM.GE.1.AND.MCHAE(II).EQ.1) GO TO 777
      IF(MEHAM.GE.1) GO TO 777
...
C     *******************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z) 
      REAL*8 FF1,FF2,GG1,GG2,RF1,RF2,F1I,F2I,RG1,RG2,G1I,G2I,ZNI,
...
C     *******************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z) 
      REAL*8 BMR,BMI,ABR,ABI
      REAL*8 FR1,FR2,FI1,FI2
      REAL*8 FFR1,AB,FR
      COMMON/JNN/CSS,INCC,NCLL,NSS,NJ,INCR
      COMMON/CVINV/BMR(40000),BMI(40000),ABR(40000),ABI(40000)
      COMMON/IW/LG
...
C     *******************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z) 
      REAL*8 AMM,AMAI,AIAMAI
      REAL*8 FR1,FR2,FI1,FI2
      REAL*8 PIV,ELEM,SUMD,SUMN,AA,A
      COMMON/MENU/MEJOB,MEPOT,MEHAM,MECHA,MEPRI,MESOL,MESHA,MESHO,MEHAO
     *,MEAPP,MEVOL,MEREL,MECUL,MERZZ,MERRR,MEDIS,MERIP
      COMMON/IW/LG
     */FV/FR1(40000),FR2(40000),FI1(40000),FI2(40000)
