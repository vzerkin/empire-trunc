...
C
      ...
      INTEGER i, iaejcr, ianucr, ieof, ierr, iowrite, ipoten, irel, ki
      INTEGER INT
...
C COMMON variables
C
      DOUBLE PRECISION AAE(7), AQ(7), BETa, EA, EFErmi, EP, POT(7,6), 
     &                 R(7), RCOulomb, RRE(7)
      INTEGER IREl
      COMMON /POTEN1/ R, RRE, AQ, AAE, POT
