Ccc   * $Author: Capote $
Ccc   * $Date: 2007-05-13 20:54:13 $
Ccc   * $Id: main.f,v 1.163 2007-05-13 20:54:13 Capote Exp $
...
C--------Correct CN population for PE and DWBA into continuum emission
         ...
         IF (corrmsd.LT.0.0D0) THEN
            WRITE (6,*) ' '
            WRITE (6,*)
     &      'FATAL: PE+DIRECT EMISSION LARGER THEN FUSION CROSS SECTION'
            IF (MSD+MSC.GT.0 .AND. ICOmpff.GT.0) THEN
               WRITE (6,*) 'TRY TO TURN OFF COMPRESSIONAL FORM FACTOR '
               WRITE (6,*) 'SET COMPFF TO 0 IN THE OPTIONAL INPUT.'
