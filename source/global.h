...
C
     ...
     &                 FNvvomp(0:ndejc,0:ndnuc,0:25), D0_obs, D0_unc,
     &                 FNwvomp(0:ndejc,0:ndnuc,0:25), S0_obs, S0_unc,
     &                 FNavomp(0:ndejc,0:ndnuc,0:13), Gg_obs, Gg_unc,
     &                 FNwsomp(0:ndejc,0:ndnuc,0:25), TISomer,
     &                 FNasomp(0:ndejc,0:ndnuc,0:13),
     &                 FNrvomp(0:ndejc,0:ndnuc,0:13),
     &                 FNrwvomp(0:ndejc,0:ndnuc,0:13),
     &                 FNrsomp(0:ndejc,0:ndnuc,0:13),
     &                 FNawvomp(0:ndejc,0:ndnuc,0:13)
...
c
     ...
     &                  KALman, MT2, MT91, MT649, MT849, IOPran
